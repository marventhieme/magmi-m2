    ...
    <div class="container_12" id="common_config">
        <div class="grid_4 col">
            ...
            <ul class="formline">
                ...
                <li class="value"><select name="DATABASE:connectivity" id="DATABASE:connectivity">
                        ...
                        <option value="localxml" <?php echo $curconn == "localxml" ? 'selected="selected"' : '' ?>>Using
                            magento.xml
                        </option>
                        <option value="envphp" <?php echo $curconn == "envphp" ? 'selected="selected"' : '' ?>>Using
                            env.php
                        </option>
                    </select></li>
            </ul>
            ...
            <div id="connectivity:localxml"
                 class="connectivity" <?php echo $curconn != 'localxml' ? 'style="display: none;"' : '' ?>>
                <ul class="formline">
                    <li class="label">Resource:</li>
                    <li class="value"><select id="select_localxml_resources" name="DATABASE:resource">
                            <option
                                value="<?php echo $conf->get('DATABASE', 'resource', 'default_setup'); ?>"><?php echo $conf->get('DATABASE', 'resource', 'default_setup'); ?></option>
                        </select>
                </ul>
            </div>
            <?php if ($cansock) {
        ...
        <div class="grid_4 col">
            ...
            <ul class="formline" style="height: 40px">
                ...
                <li class="value">
                    <input type="text"
                           name="MAGENTO:basedir"
                           value="<?php echo $conf->get("MAGENTO", "basedir") ?>">
                </li>
            </ul>
            <ul class="formline" style="height: 40px">
                <li class="label">Full path to magento command, incl. php</li>
                <li class="value">
                    <input type="text"
                           name="MAGENTO:magento_command"
                           value="<?php echo $conf->get("MAGENTO", "magento_command", "/usr/bin/php8.3 /var/www/share/staging2.kreativhaus.de/current/bin/magento") ?>">
                </li>
            </ul>
        </div>
        <div class="grid_4 col omega">
            ...
            <ul class="formline" id="noattsetupdate">
                ...
                <li class="value">
                    ...
                    <input type="hidden" id="noattsetupdate_hf" name="GLOBAL:noattsetupdate"
                           value="<?php echo $conf->get("GLOBAL", "noattsetupdate", "off") ?>"/>
